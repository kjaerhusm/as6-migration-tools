        ...
        if "<mappView " in line and "Version=" in line:
            ...
            if match:
                ...
                log(
                    ...
                    "\n  Change the following settings in the OPC Client/Server configuration (" + utils.url("Configuration View/Connectivity/OpcUaCs/UaCsConfig.uacfg") + "):"
                    ...
                    "\n  Change the following settings in mappView configuration (" + utils.url("Configuration View/mappView/Config.mappviewcfg") + "):"
