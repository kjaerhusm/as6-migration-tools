...
ren "dist\as6-migration-tools.exe" "as6-migration-tools-v_not_released.exe" >nul 2>&1

echo.
if exist "dist\as6-migration-tools-v_not_released.exe" (
  echo Done! Find it at: dist\as6-migration-tools-v_not_released.exe
) else (
